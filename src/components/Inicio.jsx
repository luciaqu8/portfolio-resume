  ...
  return (
    <div name='inicio' className='w-full h-screen bg-[#2F2333]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <p className='text-gray-500 py-4 max-w-[700px]'>Me dedico al diseño y armado de páginas web y diferentes interfaces, tengo experiencia con bases de datos (relacionales y no relacionales), y también en el ambiente artístico como diseñadora gráfica, fotográfa y community manager.
            </p>
            <div>
                <button
